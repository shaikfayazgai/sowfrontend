...
export const Modal: React.FC<ModalProps> = ({
  ...
  // depend ONLY on `open`. Depending on `onClose` (often an inline arrow that
  // changes identity every parent render) re-ran this effect on each keystroke,
  // calling dialogRef.focus() and stealing focus from inputs inside the modal.
