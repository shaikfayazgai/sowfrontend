...
│                                                                │
│ Workforce sourcing                                            │
│ ○ Internal only (my organization)                             │
│ ○ External only (Glimmora network)                            │
│ ◉ Hybrid (set per task below)                                   │
│                                                                │
│ Reviewer routing (when external or hybrid external task)      │
│ ◉ Mentor only                                                  │
│ ○ Mentor + Internal reviewer (two-stage)                      │
│   Internal reviewer: [ ▾ ]                                    │
│ ○ Internal only — manager / ent.reviewer (no Glimmora mentor)│
│   For HRIS-synced employees; see doc 09                       │
│                                                                │
│ [ Cancel ]                              [ Save task ]         │
└──────────────────────────────────────────────────────────────┘
```
