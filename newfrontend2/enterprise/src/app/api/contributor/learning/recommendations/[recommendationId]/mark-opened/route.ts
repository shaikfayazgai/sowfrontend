...
/* ── POST /api/contributor/learning/recommendations/[recommendationId]/mark-opened */
...
export async function POST(
  ...
  const url = `${BACKEND}/api/contributor/learning/recommendations/${encodeURIComponent(recommendationId)}/mark-opened`;
